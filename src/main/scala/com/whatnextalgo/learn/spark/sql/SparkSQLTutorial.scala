package com.whatnextalgo.learn.spark.sql

import com.whatnextalgo.learn.spark.utils.Context

object SparkSQLTutorial extends App with Context{
  ...
  sparkSession
    .sql("select id, tag from so_tags where tag = 'php'")
    .show()
